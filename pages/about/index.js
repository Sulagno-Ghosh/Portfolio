...
export const aboutData = [
  {
    ...
    info: [
      ...
      {
        title: "AI frameworks",
        icons: [<SiPytorch />, <SiTensorflow />, <SiNumpy />, <SiPandas />],
      },
      {
  ...
  },
  {
    ...
    info: [
      ...
      },
      {
        ...
        stage:
          "Came third position by making a GPS app for reduced carbon emission",
      },
    ],
  },
  {
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className="flex-1 flex flex-col justify-center">
          <motion.h2
            ...
            className="h2"
          >
            Confused <span className="text-accent">SDE</span> with a Global
            Perspective
          </motion.h2>
          <motion.p
